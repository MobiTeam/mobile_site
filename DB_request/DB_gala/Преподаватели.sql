...
select rownum rn, tab, fio, prof, frate, fcategory, datereg, fname, fbud, stavka, fcinf3, fcref3, fnaikat, decode(flprizn,0,'Основное','Внутренее совместительство') prizn,t.ftarif 
       from tarstav t INNER JOIN
            (select 
                    p.ftabnmb tab, p.ffio$up fio, c.fname prof, a.frate, a.fcategory, to_oradate(a.fappointdate) datereg, c1.fname, decode(c2.fname,NULL,'Не проставлен',c2.fname) as fbud, s.fcategory stavka, s.fcinf3, a.fcref3, k.fnaikat, a.flprizn,a.ftariff 
                    from 
